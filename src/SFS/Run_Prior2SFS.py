...
params_sfs = MsPrime2SFS.wrapper(sim_func=demography, params_file=args.params_file, samples=args.inds,total_length=args.total_length,ldblock=args.ldblock,mut_rate=args.mutation_rate,threads=args.threads)
